...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, Dimensions, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard, Alert } from 'react-native';
import { Ionicons, FontAwesome5 } from '@expo/vector-icons'; // Aggiunto FontAwesome per icona Google
...
const styles = StyleSheet.create({
  ...
  googleBtn: { backgroundColor: 'white', borderRadius: 8, height: 50, justifyContent: 'center', alignItems: 'center', marginTop: 15, flexDirection: 'row' },
